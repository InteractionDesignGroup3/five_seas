...
/**
 * Represents a single day's data (essentially a list of data points plus a number of parameters
 * specific to the day)
 *
...
public class DataSequence implements Comparable<DataSequence> {
  ...
  /**
   * Initialises a new data sequence with the given start time and minimum and maximum temperatures
   * and list of data points
   *
   ...
   */
  public DataSequence(
      long time, double maxTemperature, double minTemperature, List<DataPoint> sequence) {
    this.time = time;
